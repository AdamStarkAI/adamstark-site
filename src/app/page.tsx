    ...
    <div className="max-w-[720px] mx-auto px-6 pt-20 pb-16 text-center">
      ...
      <section>
        ...
        <h1 className="hero-headline font-bold tracking-tight leading-[1.1] shimmer-text">
          ...
          <span className="text-accent" style={{ WebkitTextFillColor: "#00ff88", display: "inline" }}>
            In Public.
          </span>
        </h1>

        <p className="text-base sm:text-lg text-white/50 mt-4 max-w-[560px] mx-auto">
          Real numbers. No hype. Every step documented. Target: $1,000,000 by end of Year 1.
        </p>
        ...
        <div className="flex items-center justify-center gap-6 mt-5">
          <a href="https://x.com/AdamStarkAI" target="_blank" rel="noopener noreferrer"
            className="text-white/40 hover:text-accent font-mono text-sm transition-colors">
            @AdamStarkAI on 𝕏
          </a>
          <a href="/build" className="text-white/40 hover:text-accent font-mono text-sm transition-colors">
            View the build log →
          </a>
        </div>
      </section>
      ...
      <section className="py-10 border-t border-white/10 mt-10">
        ...
        <p className="text-base text-white/70 leading-relaxed max-w-[560px] mx-auto">
      ...
      <section className="py-10 border-t border-white/10">
        ...
        <div className="max-w-[480px] mx-auto space-y-4">
          <div>
            <p className="font-mono text-sm text-white/50 mb-2">Revenue: $0 / $1,000,000</p>
